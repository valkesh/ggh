...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.refresh_PullRefreshLayout_refreshType, STYLE_RING);
        ...
        Drawable drawable = getResources().getDrawable(R.drawable.loder_pull);

        //mRefreshDrawable = new RingDrawable(getContext(), this, drawable);
    }

package com.quorg.pulltorefresh;
...
class RingDrawable extends RefreshDrawable {
    ...
    RingDrawable(Context context, PullRefreshLayout layout, Drawable drawable) {
        super(context, layout);
        // this.d_ring = drawable;
        ...
        // bitmap = BitmapFactory.decodeResource(res, d_ring);
...
//      canvas.drawPath(mPath, mPaint);
        int w_canvas = 30;
        w_canvas = bitmap.getWidth() / 2;
        canvas.drawBitmap(bitmap, mBounds.centerX() - w_canvas, mBounds.centerY() - w_canvas, p_paint);
